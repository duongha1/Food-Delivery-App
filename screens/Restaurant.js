...
const Restaurant = ({route, navigation}) =>{
    ...
    function sumOrder(){
        let total = orderItems.reduce((a,b)=> {return a+(b.total || 0)},0)
        return total;
    }
        ...
        return (
            <View>
                ...
                >
                    ...
                    >
                        <Text style={{...FONTS.h3}}>{getBasketItemCount()} in Cart</Text>
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            />
                            <Text style={{marginLeft: SIZES.padding, ...FONTS.h4}}>222</Text>
                        </View>
                    </View>
